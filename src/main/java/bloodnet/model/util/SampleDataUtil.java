...
public class SampleDataUtil {
    ...
    public static ReadOnlyPersonList getSamplePersonList() {
        PersonList sampleList = new PersonList();
        for (Person samplePerson : getSamplePersons()) {
            sampleList.addPerson(samplePerson);
        }
        return sampleList;
    }
    ...
    public static ReadOnlyDonationRecordList getSampleDonationRecordList() {
        DonationRecordList sampleList = new DonationRecordList();
        for (DonationRecord sampleDonationRecord : getSampleDonationRecords()) {
            sampleList.addDonationRecord(sampleDonationRecord);
        }
        return sampleList;
    }
}
