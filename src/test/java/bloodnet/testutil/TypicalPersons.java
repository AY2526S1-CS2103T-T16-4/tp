...
public class TypicalPersons {
    ...
    public static final Person CARL = new PersonBuilder()
            .withId(UUID.fromString("0bd76fb4-244b-41ee-b220-b4f03b12d6c7")).withName("Carl Kurz").withPhone("95352563")
            .withEmail("heinz@example.com").withDateOfBirth("04-05-1994").withBloodType("B+").build();
    public static final Person DANIEL = new PersonBuilder()
            .withId(UUID.fromString("68e79db6-37d9-4e0a-a02a-1831bb6a9f20")).withName("Daniel Meier").withPhone("87652533")
            .withEmail("cornelia@example.com").withDateOfBirth("12-12-1992")
            .withBloodType("B-").build();
    public static final Person ELLE = new PersonBuilder()
            .withId(UUID.fromString("84901d92-c6af-438a-9f87-7b24e926f01c")).withName("Elle Meyer").withPhone("94822242")
            .withEmail("werner@example.com").withBloodType("O-").withDateOfBirth("03-04-1998").build();
    public static final Person FIONA = new PersonBuilder()
            .withId(UUID.fromString("781f4d25-e281-4e9e-ba2a-e903446d1191")).withName("Fiona Kunz").withPhone("94824271")
            .withEmail("lydia@example.com").withBloodType("O+").withDateOfBirth("01-02-1996").build();
    public static final Person GEORGE = new PersonBuilder()
            .withId(UUID.fromString("c633e609-304e-4d8f-ad18-8c4694ad05fd")).withName("George Best").withDateOfBirth("01-01-2002")
            .withPhone("94824422")
