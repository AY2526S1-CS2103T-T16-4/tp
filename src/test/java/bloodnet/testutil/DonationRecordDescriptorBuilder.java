 ...
 */
public class DonationRecordDescriptorBuilder {

    private EditPersonDescriptor descriptor;

    public DonationRecordDescriptorBuilder() {
        descriptor = new EditPersonDescriptor();
    }

    public DonationRecordDescriptorBuilder(EditPersonDescriptor descriptor) {
     ...
     */
    public DonationRecordDescriptorBuilder(Person person) {
        descriptor = new EditPersonDescriptor();
     ...
     */
    public DonationRecordDescriptorBuilder withName(String name) {
     ...
     */
    public DonationRecordDescriptorBuilder withPhone(String phone) {
     ...
     */
    public DonationRecordDescriptorBuilder withEmail(String email) {
     ...
     */
    public DonationRecordDescriptorBuilder withBloodType(String bloodType) {
     ...
     */
    public DonationRecordDescriptorBuilder withDateOfBirth(String dateOfBirth) {
